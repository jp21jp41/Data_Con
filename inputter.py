    ...
    def basic_read(self, str_statement = "Please enter the " + 
        ...
        if readtype == "file":
            try:
                ...
                try:
                    excel_ask = self.basic_ask("Is the file an excel file?")
                    if excel_ask:
                        print("Please enter the sheet numbers as comma")
                        print("separated numbers.")
        ...
        if readtype == "column":
            try:
                ...
                if column.name not in self.data.columns.values:
                    try:
